...
`, template.innerHTML.trim());
  ...
  var stream_default = JoinCall;

  // js/init_user.js
  var users = {};
  function addUserConnection(userUuid) {
    if (users[userUuid] === void 0) {
      users[userUuid] = {
        peerConnection: null
      };
    }
  ...
  var init_user_default = InitUser;

  // js/handler/off_request.js
  function createPeerConnection(lv, fromUser, offer) {
    ...
    if (offer === void 0) {
      newPeerConnection.onnegotiationneeded = async () => {
        try {
          newPeerConnection.createOffer().then((offer2) => {
            newPeerConnection.setLocalDescription(offer2);
            console.log("Sending this OFFER to the requester:", offer2);
            lv.pushEvent("new_sdp_offer", { toUser: fromUser, description: offer2 });
          }).catch((err) => console.log(err));
        } catch (error) {
          console.log(error);
        }
  ...
  var off_request_default = HandleOfferRequest;

  // js/handler/ice_canditate_offer.js
  var HandleIceCandidateOffer = {
    mounted() {
  ...
  var ice_canditate_offer_default = HandleIceCandidateOffer;

  // js/handler/sdp_offer.js
  var HandleSdpOffer = {
    mounted() {
      let data = this.el.dataset;
      let fromUser = data.fromUserUuid;
  ...
  var sdp_offer_default = HandleSdpOffer;

  // js/handler/answer.js
  var HandleAnswer = {
    mounted() {
      let data = this.el.dataset;
      let fromUser = data.fromUserUuid;
  ...
  var answer_default = HandleAnswer;

  // js/app.js
  var hooks = {
    JoinCall: stream_default,
    InitUser: init_user_default,
    HandleOfferRequest: off_request_default,
    HandleIceCandidateOffer: ice_canditate_offer_default,
    HandleSdpOffer: sdp_offer_default,
    HandleAnswer: answer_default
  };
